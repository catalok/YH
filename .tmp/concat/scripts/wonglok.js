...
(function (window, angular, Hammer) {
  var hmTouchEvents = angular.module('hmTouchEvents', []), hmGestures = [
      'hmHold:hold',
      'hmTap:tap',
    ...
    hmTouchEvents.directive(directiveName, [
      ...
      function ($parse, $window) {
        return {
          restrict: 'A, C',
          link: function (scope, element, attr) {
            var expr = $parse(attr[directiveName]), fn = function (event) {
                scope.$apply(function () {
                  expr(scope, { $event: event });
                });
              }, opts = $parse(attr['hmOptions'])(scope, {}), hammer;
...
'use strict';
angular.module('yhApp').controller('MainCtrl', [
  '$scope',
  'lokBlog',
  function ($scope, lokBlog) {
    $scope.lokBlog = lokBlog;
  }
]);
'use strict';
angular.module('yhApp').controller('HomeCtrl', [
  '$scope',
  function ($scope) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
...
'use strict';
angular.module('yhApp').controller('WorkCtrl', [
  '$scope',
  function ($scope) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
...
'use strict';
angular.module('yhApp').controller('CvCtrl', [
  '$scope',
  function ($scope) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
...
angular.module('yhApp').factory('_doTransEnd', function () {
...
]).factory('animationClass', [
  'isMobile',
  'deviceChecker',
  function (isMobile, deviceChecker) {
    var list = {
        lok3dPages: [
  ...
  Mediator.prototype.publish = function mediatorPublish() {
    ...
    for (var i = 0, len = this._topics[topic].length; i < len; i++) {
      this._topics[topic][i].apply(null, args);  // console.log(topic, this._topics[ topic ][ i ]);
    }
    return true;
  };
  ...
  return Mediator;
}).factory('offNavMediator', [
  'Mediator',
  '$injector',
  function (Mediator, $injector) {
...
]).factory('scrollRestoreService', [
  '$rootScope',
  'isMobile',
  '$location',
  function ($rootScope, isMobile, $location) {
    return {
      scrollRestore: function (offNavMediator) {
        ...
        var console = { log: noop };
        var menuOpened = false, canSaveScroll = true, scrollPos = {}, curPath = $location.path();
        ;
        //default
...
]).directive('lokContainer', [
  'clickEvent',
  'offNavMediator',
  '_doTransEnd',
  'animationClass',
  function (clickEvent, offNavMediator, _doTransEnd, animationClass) {
    return {
      restrict: 'C',
...
]).directive('lokNavTrigger', [
  'clickEvent',
  'offNavMediator',
  function (clickEvent, offNavMediator) {
    return {
      restrict: 'C',
      controller: [
        '$scope',
        ...
        function ($scope, $element) {
          ...
          offNavMediator.publish('menu:open');  // $element[0].addEventListener('mouseover',_onClickMenuBtn);
        }
      ]
    };
  }
]).directive('lokMenuBtn', [
  'clickEvent',
  'offNavMediator',
  '$rootScope',
  function (clickEvent, offNavMediator, $rootScope) {
    return {
      restrict: 'C',
      controller: [
        '$scope',
...
'use strict';
/* global NProgress */
angular.module('yhApp').controller('SettingsCtrl', [
  '$routeParams',
  '$rootScope',
  '$scope',
  'offNavMediator',
  '$location',
  function ($routeParams, $rootScope, $scope, offNavMediator, $location) {
...
'use strict';
angular.module('yhApp').controller('ContactCtrl', [
  '$scope',
  function ($scope) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
...
'use strict';
angular.module('yhApp').factory('lokBlog', function () {
  var self = {
      prefix: 'views/blogs/',
      suffix: '.html',
      blogs: ['20140602-chromeDevTools'],
      getUrl: function (url) {
...
'use strict';
angular.module('yhApp').controller('BlogCtrl', [
  '$scope',
  'lokBlog',
  '$routeParams',
  '$location',
  function ($scope, lokBlog, $routeParams, $location) {
